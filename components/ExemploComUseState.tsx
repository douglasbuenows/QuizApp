...
const styles = StyleSheet.create({
  ...
  title: {
    // Título em roxo-escuro e mais arredondado
    fontSize: 28,
    fontWeight: "bold",
    marginBottom: 20,
    color: "#4B427F",
  ...
  valueText: {
    // Valor em azul-escuro para destaque
    fontSize: 56,
    fontWeight: "bold",
    color: "#3B5998",
    marginVertical: 10,
  ...
  explanation: {
    // Texto explicativo em cinza-escuro
    textAlign: "center",
    marginTop: 10,
    color: "#4A4A4A",
    lineHeight: 22,
  ...
  input: {
    // Campo de entrada com borda sutil
    height: 50,
    borderColor: "#A8A2DB",
    borderWidth: 1,
    borderRadius: 12,
